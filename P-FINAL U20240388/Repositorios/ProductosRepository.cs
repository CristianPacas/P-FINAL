...
namespace LAB3_U20240388.Repositorios
{
    public class ProductosRepository
    {
        ...
        public void AgregarProducto(Productos producto)
        {
            ...
            {
                string query = @"
                    INSERT INTO Productos (Nombre, Codigo, Categoria, PrecioUnitario, Cantidad)
                    VALUES (@Nombre, @Codigo, @Categoria, @PrecioUnitario, @Cantidad)";
        ...
        public DataTable ObtenerTodos()
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                string query = "SELECT IdProducto, Nombre, Codigo, Categoria, PrecioUnitario, Cantidad FROM Productos";
                SqlCommand cmd = new SqlCommand(query, conn);
